 ...
 function checkPost(){
     window.open("checkPost.jsp","","width=400 height=400 left=350 top=200 scrollbars=yes");
 }
 function checkId(){
	 ...
	 if(sid==""){
		 ...
		 window.open("checkId.jsp?id="+sid,"","width=300 height=100 location=yes left=300px top=100px");
 }
 function check(){
